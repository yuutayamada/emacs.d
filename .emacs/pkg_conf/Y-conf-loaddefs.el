...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "init_mykie" '("my/overriding-mode-map")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "init_yasnippet" '("yas-snippet-dirs")))
...
;;;;;;  "init_node-console.el" "init_nyan-mode.el" "init_org-trello.el"
